...
namespace UniversityAdministration.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(UniversityAdministrationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CourseId,Title,Etcs")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseId,Title,Etcs")] Course course)
        {
